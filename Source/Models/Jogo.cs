...
{
    /// <summary> 
    /// Classe responsável por controlar todas as requisições entre o cliente e o servidor ///
    /// </summary>
    [HubName("jogo")]
    public class Jogo : Hub
    {
        ...
        /// <summary> 
        /// Método sobrescrito da classe Hub. É executado quando o jogador se disconecta do site. /// 
        /// </summary> 
        /// <returns>Retorna um objeto de tipo Thread (tarefa)</returns>
        ...
        /// <summary> 
        /// Método que irá cadastrar o jogador para o jogo da velha
        /// </summary>
        /// <param name="nome">Recebe o nome do jogador</param>
        ...
        {   // bloqueia o processo quando cadastra o jogador
            ...
            Clients.Client(Context.ConnectionId).confirmarCadastro();
        }
        /// <summary> 
        ...
        {   
            ...
            return Clients.All.atualizaInformacoesJogos(new { qtdPartidas = listaPartidas.Count, qtdJogadores = listaJogadores.Count });
        }
        /// <summary> 
